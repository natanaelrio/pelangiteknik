    ...
    const data = [,
        {
            ...
            "data": [
                {
                    "gambar": "https://api-prod.duitku.com/pgimages/pg/VC.svg",
                    "judul": "CREDIT CARD",
                    "kode": "VC",
                    "kodeMid": 'credit_card',
                    "des": ''
        ...
        },
        {
            ...
            "data": [
                {
                    "gambar": "https://api-sandbox.duitku.com/pgimages/pg/BC.svg",
                    "judul": "BCA VA",
                    "kode": "BC",
                    "kodeMid": 'bca_va',
                    "des": 'Tanpa Biaya Admin'
                },
                {
                    "gambar": "https://api-sandbox.duitku.com/pgimages/pg/M2.svg",
                    "judul": "MANDIRI VA H2H ",
                    "kode": "M2",
                    "des": 'Tanpa Biaya Admin'
                },
                {
                    "gambar": "https://api-sandbox.duitku.com/pgimages/pg/I1.svg",
                    "judul": "BNI VA",
                    "kode": "I1",
                    "kodeMid": "bni_va",
                    "des": 'Tanpa Biaya Admin'
                ...
                {
                    "gambar": "https://api-sandbox.duitku.com/pgimages/pg/BR.svg",
                    "judul": "BRI VA",
                    "kode": "BR",
                    "kodeMid": "bri_va",
                    "des": 'Tanpa Biaya Admin'
                ...
                {
                    "gambar": "https://api-sandbox.duitku.com/pgimages/pg/BT.svg",
                    "judul": "PERMATA VA",
                    "kode": "BT",
                    "kodeMid": "permata_va",
                    "des": 'Tanpa Biaya Admin'
                ...
                {
                    "gambar": "https://api-sandbox.duitku.com/pgimages/pg/B1.svg",
                    "judul": "CIMB NIAGA VA",
                    "kode": "B1",
                    "kodeMid": "cimb_va",
                    "des": 'Tanpa Biaya Admin'
                ...
                {
                    "gambar": "https://api-sandbox.duitku.com/pgimages/pg/VA.svg",
                    "judul": "MAYBANK VA",
                    "kode": "VA",
                    "des": 'Tanpa Biaya Admin'
                },
                {
                    "gambar": "https://api-prod.duitku.com/pgimages/pg/BV.svg",
                    "judul": "BSI VA",
                    "kode": "BV",
                    "des": 'Tanpa Biaya Admin'
                },
                {
                    "gambar": "https://api-sandbox.duitku.com/pgimages/pg/NC.svg",
                    "judul": "BNC VA",
                    "kode": "NC",
                    "des": 'Tanpa Biaya Admin'
                },
                {
                    "gambar": "https://api-sandbox.duitku.com/pgimages/pg/AG.svg",
                    "judul": "ARTHA GRAHA VA",
                    "kode": "AG",
                    "des": 'Tanpa Biaya Admin'
                },
                {
                    "gambar": "https://api-sandbox.duitku.com/pgimages/pg/A1.svg",
                    "judul": "ATM BERSAMA VA",
                    "kode": "A1",
                    "des": 'Tanpa Biaya Admin'
                },
                {
                    "gambar": "https://api-prod.duitku.com/pgimages/pg/S1.svg",
                    "judul": "SAMPOERNA VA",
                    "kode": "S1",
                    "des": 'Tanpa Biaya Admin'
                }
        ...
        ,
        {
            ...
            "data": [
                {
                    "gambar": "https://api-prod.duitku.com/pgimages/pg/OV.svg",
                    "judul": "OVO",
                    "kode": "OV",
                    "des": 'Tanpa Biaya Admin'
                },
                {
                    "gambar": "https://api-prod.duitku.com/pgimages/pg/DA.svg",
                    "judul": "DANA",
                    "kode": "DA",
                    "des": 'Tanpa Biaya Admin'
                },
                // {
                //     "gambar": `${process.env.NEXT_PUBLIC_URL}/gopay.svg`,
                //     "judul": "Gopay",
                //     "kode": "DA",
                //     "kodeMid": 'gopay',
                //     "des": '2% / transaksi'
                // },
                // {
                //     "gambar": "https://api-prod.duitku.com/pgimages/pg/SA.svg",
                //     "judul": "Shopeepay",
                //     "kode": "shopeepay",
                //     "kodeMid": "shopeepay",
                //     // "des": '2% / transaksi'
                // },
                //  {
                //     "gambar": `${process.env.NEXT_PUBLIC_URL}/qris.svg`,
                //     "judul": "QRIS",
                //     "kode": "FT",
                //     "kodeMid": "other_qris",
                //     "des": '0.7% / transaksi'
        ...
        // {
        //     "bank": "Cardless Credit/BNPL",
        //     "data": [
        //         {
        //             "gambar": `${process.env.NEXT_PUBLIC_URL}/akulaku.svg`,
        //             "judul": "Akulaku",
        //             "kode": "DA",
        //             "kodeMid": 'akulaku',
        //             "des": '1.7% / transaksi'
        //         },
        //         {
        //             "gambar": `${process.env.NEXT_PUBLIC_URL}/kredivo.svg`,
        //             "judul": "Kredivo",
        //             "kode": "DA",
        //             "kodeMid": 'kredivo',
        //             "des": '2% / transaksi'
        ...
        // },
        {
            ...
            "data": [
                {
                    "gambar": "https://api-prod.duitku.com/pgimages/pg/NQ.svg",
                    "judul": "NOBU QRIS",
                    "kode": "NQ",
                    // "des": 'Rp 0 + 0.70% / transaksi'
                    "des": 'Tanpa Biaya Admin'
                },
                {
                    "gambar": "https://api-prod.duitku.com/pgimages/pg/SP.svg",
                    "judul": "SHOPEEPAY QRIS",
                    "kode": "SP",
                    "des": 'Tanpa Biaya Admin'
                }
            ]
        },
        {
            ...
            "data": [
                {
                    "gambar": `${process.env.NEXT_PUBLIC_URL}/alfamart.svg`,
                    "judul": "Alfamart",
                    "kode": "FT",
                    // "kodeMid": "alfamart",
                    "des": 'Tanpa Biaya Admin'
                    // "des": 'IDR 5.000/transaksi'
                },
                // {
                //     "gambar": `${process.env.NEXT_PUBLIC_URL}/indomaret.svg`,
                //     "judul": "Indomaret",
                //     "kode": "FT",
                //     "kodeMid": "indomaret",
                //     "des": 'IDR 5.000/transaksi'
...
export const CreateItem = async (data, method) => {
    try {
        await fetch(`${process.env.NEXT_PUBLIC_URL_API}/api/cart/createItem`, {
            method: method,
            headers: {
                'Content-Type': 'application/json',
                'Authorization': `${process.env.NEXT_PUBLIC_SECREET}`
...
export const GetIDCart = async (email) => {
    try {
        const res = await fetch(`${process.env.NEXT_PUBLIC_URL_API}/api/cart/getIDcart?email=${email}`, {
            headers: {
                'Content-Type': 'application/json',
                'Authorization': `${process.env.NEXT_PUBLIC_SECREET}`
            },
...
export const UpdateVoucher = async (id) => {
    try {
        const res = await fetch(`${process.env.NEXT_PUBLIC_URL_API}/api/cart/updateVoucher`, {
            headers: {
                'Content-Type': 'application/json',
                'Authorization': `${process.env.NEXT_PUBLIC_SECREET}`
            },
...
export const GetVoucher = async (voucher) => {
    try {
        const res = await fetch(`${process.env.NEXT_PUBLIC_URL_API}/api/cart/getVoucher?voucher=${voucher}`, {
            headers: {
                'Content-Type': 'application/json',
                'Authorization': `${process.env.NEXT_PUBLIC_SECREET}`
            },
...
export const UpdateCount = async (data) => {
    ...
    try {
        await fetch(`${process.env.NEXT_PUBLIC_URL_API}/api/cart/updateQuantity`, {
            method: 'PUT',
            headers: {
                'Content-Type': 'application/json',
                'Authorization': `${process.env.NEXT_PUBLIC_SECREET}`
...
export const DeleteCart = async (data) => {
    ...
    try {
        await fetch(`${process.env.NEXT_PUBLIC_URL_API}/api/cart/deleteItem`, {
            method: 'DELETE',
            headers: {
                'Content-Type': 'application/json',
                'Authorization': `${process.env.NEXT_PUBLIC_SECREET}`
...
export const UpserFromData = async (data) => {
    try {
        await fetch(`${process.env.NEXT_PUBLIC_URL_API}/api/cart/FormData`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'Authorization': `${process.env.NEXT_PUBLIC_SECREET}`
...
export const UpserOngkosKirim = async (data) => {
    try {
        await fetch(`${process.env.NEXT_PUBLIC_URL_API}/api/cart/ongkosKirim`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'Authorization': `${process.env.NEXT_PUBLIC_SECREET}`
...
export const CreateDataPesanan = async (id, fromItems) => {

    try {
        await fetch(`${process.env.NEXT_PUBLIC_URL_API}/api/cart/createDataPesanan`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'Authorization': `${process.env.NEXT_PUBLIC_SECREET}`
...
export const GetDataPesanan = async (id) => {
    try {
        const res = await fetch(`${process.env.NEXT_PUBLIC_URL_API}/api/cart/getDataPesanan?id=${id}`, {
            headers: {
                'Content-Type': 'application/json',
                'Authorization': `${process.env.NEXT_PUBLIC_SECREET}`
            },
...
export async function PostFixDataPengiriman(GabungData) {
    try {
        // DUITKU
        const resPayment = await fetch(`${process.env.NEXT_PUBLIC_URL_API}/api/paymentDuitku/get-token`, {
            method: 'POST',
...
export const GetNotaPesanan = async (id) => {
    try {
        // DATA ADMIN
        const res = await fetch(`${process.env.NEXT_PUBLIC_URL_API}/api/cart/notaPesanan?merchantOrderId=${id}`, {
            method: 'GET',
            headers: {
                'Content-Type': 'application/json',
                'Authorization': process.env.NEXT_PUBLIC_SECREET
...
export const GetProvice = async (id) => {
    try {
        // DATA ADMIN
        const res = [
            {
