...
`;
    ...
    const encodedMessage = productDetail && encodeURIComponent(
        `Halo ${NumberSales?.name}, saya butuh bantuan lebih lanjut mengenai product dan diskon 3%: ${productDetail.productName}
        ...
        `Halo ${NumberSales?.name}, saya butuh bantuan lebih lanjut mengenai produk dan diskon 3%: ${Header.q ? Unslugify(Header.q) : 'Pelangi Teknik'}
